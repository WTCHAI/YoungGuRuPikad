...
const dataLocationMap: Record<string, LatLngExpression> = {
  "2025-07-20": [13.7466, 100.5395], // Central World
  "2025-07-21": [13.746, 100.5346], // Siam Paragon
  "2025-07-22": [13.8008, 100.552], // Chatuchak
  "2025-07-23": [13.7372, 100.5609], // Asoke
  "2025-07-24": [13.7651, 100.6423], // Bang Kapi
}
